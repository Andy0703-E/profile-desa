...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div>
        ...
        <p style="font-size: 0.85rem; color: #64748b;">Kelola program strategis yang tampil pada halaman depan portal desa</p>
    </div>
    <a href="<?= base_url('admin/program-unggulan/create') ?>" style="display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.6rem 1.25rem; background: #0b6045; color: #ffffff; border-radius: 8px; font-weight: 700; font-size: 0.85rem; text-decoration: none;">
        <i data-lucide="plus" style="width: 16px; height: 16px;"></i> Tambah Program
    </a>
</div>
                        ...
                        <tr style="border-bottom: 1px solid #f1f5f9;">
                            ...
                            <td style="padding: 0.85rem 1rem; text-align: center;">
                                <div style="display: flex; gap: 0.4rem; justify-content: center;">
                                    <a href="<?= base_url('admin/program-unggulan/edit/' . $row['id']) ?>" style="padding: 0.35rem 0.6rem; border-radius: 6px; background: #fef3c7; color: #d97706; font-size: 0.78rem; font-weight: 700; text-decoration: none;">
                                        Edit
                                    </a>
                                    <form method="post" action="<?= base_url('admin/program-unggulan/delete/' . $row['id']) ?>" onsubmit="return confirm('Hapus program ini?');" style="display: inline;">
                                        <?= csrf_field() ?>
